...
<script type="text/javascript">
	var _menus = [ {
		...
		"menus" : [ {
			"menuid" : "1101",
			"menuname" : "自助取数",
			"url" : "pages/label/accessIndex.jsf"
		}, {
			"menuid" : "1102",
			"menuname" : "分析日志",
			"url" : "pages/label/accessLogIndex.jsf"
		} ]
	} ];
...
<body class="easyui-layout" onload="init()">
    <div data-options="region:'north',border:false" class="header">
        <i class="logo"></i> <i class="sysname"></i> <i class="welcome">欢迎您：<%=userName%></i> <a class="icon_logout"
            title="注销"></a>
    </div>
